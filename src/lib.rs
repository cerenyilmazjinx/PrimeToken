...
#[derive(Debug)]
pub struct PrimeTokenProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeTokenProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeToken processing");
    
    let mut processor = PrimeTokenProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeTokenProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeTokenProcessor::new(false);
